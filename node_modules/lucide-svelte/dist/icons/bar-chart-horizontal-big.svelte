...
const iconNode = [["path", { "d": "M3 3v18h18" }], ["rect", { "width": "12", "height": "4", "x": "7", "y": "5", "rx": "1" }], ["rect", { "width": "7", "height": "4", "x": "7", "y": "13", "rx": "1" }]];
/**
...
<Icon name="bar-chart-horizontal-big" {...$$props} iconNode={iconNode}>
  <slot/>
</Icon>
