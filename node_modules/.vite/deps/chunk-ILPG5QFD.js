...
function create_default_slot(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(22:0) <Icon name=\\"credit-card\\" {...$$props} iconNode={iconNode}>',
    ctx
  });
  return block;
}
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("Credit_card", slots, ["default"]);
  const iconNode = [
    [
      "rect",
      {
...
var Credit_card = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
...
lucide-svelte/dist/icons/credit-card.svelte:
   ...
   *)
*/
//# sourceMappingURL=chunk-ILPG5QFD.js.map
