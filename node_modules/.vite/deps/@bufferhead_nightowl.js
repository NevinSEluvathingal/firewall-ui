...
// node_modules/@bufferhead/nightowl/dist/nightowl.js
var h = "nightowl-color-scheme";
var l = "light";
var o = "dark";
var n = null;
var t = l;
...
function M(e) {
  g = false, e.defaultMode === "dark" && (t = o), e.toggleButtonMode && (i = e.toggleButtonMode), document.readyState === "complete" ? (a(), d(), c()) : window.addEventListener("load", () => {
    a(), d(), c();
  });
}
...
//# sourceMappingURL=@bufferhead_nightowl.js.map
