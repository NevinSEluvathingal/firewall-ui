...
function create_default_slot(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(22:0) <Icon name=\\"dollar-sign\\" {...$$props} iconNode={iconNode}>',
    ctx
  });
  return block;
}
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("Dollar_sign", slots, ["default"]);
  const iconNode = [
    [
      "line",
      {
...
var Dollar_sign = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
...
lucide-svelte/dist/icons/dollar-sign.svelte:
   ...
   *)
*/
//# sourceMappingURL=chunk-4WIBEJFJ.js.map
